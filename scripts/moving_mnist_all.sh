...
cat examples/moving_mnist_all.py \
    | jupytext --to ipynb \
    | papermill - "examples/moving_mnist_all_out_$model_"$use_ss"_$SLURM_JOBID.ipynb" \
    -p model_save_path "./saved_models/moving_mnist_all_$model_"$use_ss"_$SLURM_JOBID" \
    -p model_type $model \
